...
public class ErrorHandler {
    ...
    public ErrorResponse handlerPostNotFoundException(final PostNotFoundException e) {
    ...
    @ExceptionHandler
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErrorResponse handlerIncorrectParameterException(final IncorrectParameterException e) {
